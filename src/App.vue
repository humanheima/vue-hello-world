  ...
  <div id="app">
    ...
    <div v-else class="component-page">
      ...
      <main class="component-content">
        ...
        <AttributeComponent v-if="currentComponent === 'AttributeComponent'" class="btn_class_one" @click="parentClick" />
        <AttributeOutComponent v-if="currentComponent === 'AttributeOutComponent'" class="btn_class_one" @click="parentClick" />
        <EventCustom v-if="currentComponent === 'EventCustom'" @custom_devent="handleCustomEvent" />
        <VmodelComponent v-if="currentComponent === 'VmodelComponent'" v-model:model-value="message" v-model:model-value2="name" />
        <CapitalizeComponent v-if="currentComponent === 'CapitalizeComponent'" v-model.modelValue.capitalize="myText" />
